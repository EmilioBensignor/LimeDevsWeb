<template>
  <header
    class="flex flex-col sm:flex-row sm:justify-between items-center gap-3 sticky top-0 z-10 bg-dark py-4 md:py-7 2xl:py-8 px-6 md:px-[3.75rem] 2xl:px-[5.625rem]">
